...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		...
		{
			src: "./public/favicon/ht.jpg", // Path of the favicon, relative to the /public directory
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "统计",
			url: "https://umami.cnm.at13xe.top/share/XuUvxYiIrWVVR2y4", // Internal links should not include the base path, as it is automatically added
...
export const umamiConfig: UmamiConfig = {
	enable: true,
	baseUrl: "https://umami.cnm.at13xe.top",
	shareId: "XuUvxYiIrWVVR2y4",
