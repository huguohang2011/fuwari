...
export const siteConfig: SiteConfig = {
	...
	background: {
		...
		src: "https://pic.atxe.qzz.io/h", // Background image URL (supports HTTPS)
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "统计",
			url: "https://umami.at13xe.qzz.io/share/7RFs2tSQQnjFoRCZ", // Internal links should not include the base path, as it is automatically added
